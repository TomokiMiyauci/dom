...
import { HTMLStyleElement } from "../../html/elements/html_style_element.ts";
import { HTMLLinkElement } from "../../html/elements/html_link_element.ts";
...
declare module "../../html/elements/html_style_element.ts" {
  interface HTMLStyleElement extends LinkStyle {}
}

declare module "../../html/elements/html_link_element.ts" {
